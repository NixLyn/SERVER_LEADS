...
class File_man():
    ...
    def build_tree(self):
        try:
            ...
            #       |--CURRENT.txt
            #       |--TARGET_STATE.txt
            self.make_dir("SERVER_PY/SOCKET_DATA")
            self.make_dir("SERVER_PY/MSGS")
            self.make_dir("SERVER_PY/CHATS")
            ...
            for f in self.socket_files:
                self.write_file("SERVER_PY/SOCKET_DATA/"+str(f), "", "*", "w")
            for c in self.chats_files:
                self.write_file("SERVER_PY/CHATS/"+str(c), "", "*", "w")
